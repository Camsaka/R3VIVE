...
function CarouselComp() {
   return (
      <>
         <p className="text-2xl text-center italic">Evènements à venir</p>
         <div className="mx-auto my-12 text-center h-96 w-3/4 border-solid border-white border-y items-center flex">
